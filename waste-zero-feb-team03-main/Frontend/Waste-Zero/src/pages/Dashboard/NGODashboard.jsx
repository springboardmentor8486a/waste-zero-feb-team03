...
import { Plus, MessageSquare, Users, Activity, Sparkles } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-8 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div
            className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 shadow-sm cursor-pointer hover:border-yellow-300 hover:shadow-md transition-all"
            onClick={() => navigate("/ngo/matches")}
          >
            <div className="flex items-center gap-4">
              <div className="p-3 bg-yellow-100 text-yellow-600 rounded-lg"><Sparkles size={24} /></div>
              <div>
                <p className="text-sm text-gray-500">Volunteer Matches</p>
                <p className="text-sm font-bold text-yellow-600">View Matches →</p>
              </div>
            </div>
          </div>

          <div
            className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 shadow-sm cursor-pointer hover:border-purple-300 transition-colors"
            onClick={() => navigate("/chat/messages")}
          >
            <div className="flex items-center gap-4">
              <div className="p-3 bg-purple-100 text-purple-600 rounded-lg"><MessageSquare size={24} /></div>
              <div>
                <p className="text-sm text-gray-500">Messages</p>
                <p className="text-sm font-bold text-purple-600">Open Inbox →</p>
              </div>
            </div>
          </div>
        </div>
