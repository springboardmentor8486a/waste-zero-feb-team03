...
import OpportunityCard from "../../components/opportunity/OpportunityCard"; // Import this!
...
const VolunteerDashboard = () => {
  ...
  const loadOpen = async () => {
    try {
      // Fetches all available opportunities for the volunteer to see
            ...
            {loading ? (
              ...
              opportunities.map((opp) => (
                <OpportunityCard 
                  key={opp._id} 
                  opportunity={opp} 
                  onDelete={loadOpen} // Re-fetch data if needed
                />
              ))
            )}
          </div>
